...
/* Low=stdin handle, high=stdout handle (cmd/term already remapped). */
...
unsigned int OS_GETPATH(unsigned char *trgPathPtr); // in: de = ptr to buffer out: hl = ptr to last symbol of path
