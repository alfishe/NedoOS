 ...
 *   DATA @ 0xC000  ? panel/copy buffers (one page at a time)
 *
 * Bank roles (target layout):
 *   01 UI      ? ex-nc_resident (session bank)
 *   02 panel   ? read/sort/draw
 *   03 fileops ? copy/move/delete
 *   04 cold    ? ini/ext/shell
 */
