...
.SUB_MIDI_CTL_LSB_DATA_ENTRY:
           ld  (IX+MIDI_CHANNEL_DATA._MIDI_CTL_LSB_DATA_ENTRY-128),d    ;last rpn
         ;  call .rpn
.rpn:
           ld  a,(IX+MIDI_CHANNEL_DATA._MIDI_RPN_TYPE-128)
           cp 1 ;is rpn
           ret nz     
                                                ;         ld a,(g_header.midi_mode)
                                                ;          cp SNDRV_MIDI_MODE_NONE
                                                ;          ret z
...
;            ld l,(ix+VOICE_DATA.wave_data)
;            ld h,(ix+VOICE_DATA.wave_data+1)
;            ld de,(gv_wavedata)
;            and a
;            sbc hl,de
;            jr nz,.vo_not_cat_not_match
;                ld (free_voice),ix
;                jp .loop_exit
