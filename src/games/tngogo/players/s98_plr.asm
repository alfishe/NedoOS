...
enable_loop			
			...
			ld hl,s98_header+$04
			or (hl)
			inc hl	;(s98_header+$05)
			or (hl)	
			inc hl	;(s98_header+$06)
			or (hl)				
			inc hl	;(s98_header+$07)
			or (hl)
			jr nz,1f
				ld a,10		;default
				ld (s98_header+$04),a
1
			...
			ld hl,s98_header+$08
			or (hl)
			inc hl	;(s98_header+$09)
			or (hl)	
			inc hl	;(s98_header+$0A)
			or (hl)				
			inc hl	;(s98_header+$0B)
			or (hl)
			jr nz,1f
				ld hl,1000		;default
				ld (s98_header+$08),hl
...
s98_file00_pages_list:  ds 256,0
flag_Stop               db 0

load_s98_file_number_haddr = HIGH s98_file00_pages_list  ;0x50
...
continuation:
			...
			ld a,(s98_header+$06);	4)	;step
			ld e,a
			ld a,(s98_header+$07);	5)
			ld d,a
			ld hl,$0000	;H
				exx
				ld a,(s98_header+$04)	;6)
				ld e,a
				ld a,(s98_header+$05)	;7)
				ld d,a
				ld hl,$0000	;L
...
1
			...
			ld a,b		;H
				exx
					;L
				rla : adc hl,hl : exx : adc hl,hl : exx : add hl,de : exx :adc hl,de : exx : jr c,$+4+4 : sbc hl,de : exx : sbc hl,de : exx
				rla : adc hl,hl : exx : adc hl,hl : exx : add hl,de : exx :adc hl,de : exx : jr c,$+4+4 : sbc hl,de : exx : sbc hl,de : exx
				rla : adc hl,hl : exx : adc hl,hl : exx : add hl,de : exx :adc hl,de : exx : jr c,$+4+4 : sbc hl,de : exx : sbc hl,de : exx
				rla : adc hl,hl : exx : adc hl,hl : exx : add hl,de : exx :adc hl,de : exx : jr c,$+4+4 : sbc hl,de : exx : sbc hl,de : exx
				rla : adc hl,hl : exx : adc hl,hl : exx : add hl,de : exx :adc hl,de : exx : jr c,$+4+4 : sbc hl,de : exx : sbc hl,de : exx
...
long_FE_assembled
	...
	;	ld bc,(sync_frq)
		...
		sbc hl,bc
		ld (sync_cnt),hl
		jp m,player_frame_complete	;player_frame_complete_when_FE
...
sync_sub = $+1 :	ld bc,$0001	;3277	;3276,8		;$8000		;
			and a
			sbc hl,bc
			ld (sync_cnt),hl

			jp m,player_frame_complete
...
frame_add = $+1 :	ld de,$0000
			ld hl,(sync_cnt)
			and a
			adc hl,de
			ld (sync_cnt),hl

		;	jp m,player_frame_complete	;player_frame_complete теперь не подходит
							;ибо он сохраняет de
			ret m
...
s98_end
        ...
        savebin "t_no_gogo/s98_plr.bin",s98_begin,s98_end-s98_begin