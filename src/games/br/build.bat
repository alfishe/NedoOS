...
rem #
copy /y intro\flick.lpz\*.* %LOCALDIR%\
...
copy /y levels\w~112.dat levels\w~112.lpz
...
copy /y levels\w~117end.dat levels\w~117end.lpz
...
copy /y levels\w~205.dat levels\w~205.lpz
...
copy /y levels\w~213.dat levels\w~213.lpz
...
copy /y levels\w~217end.dat levels\w~217end.lpz

rem #
rem # Levels: save locally
rem #
copy /y levels\w~101.lpz %LOCALDIR%\br101.dat
copy /y levels\w~102.lpz %LOCALDIR%\br102.dat
copy /y levels\w~103.lpz %LOCALDIR%\br103.dat
copy /y levels\w~104.lpz %LOCALDIR%\br104.dat
copy /y levels\w~105.lpz %LOCALDIR%\br105.dat
copy /y levels\w~106.lpz %LOCALDIR%\br106.dat
copy /y levels\w~107.lpz %LOCALDIR%\br107.dat
copy /y levels\w~108.lpz %LOCALDIR%\br108.dat
copy /y levels\w~109.lpz %LOCALDIR%\br109.dat
copy /y levels\w~110.lpz %LOCALDIR%\br110.dat
copy /y levels\w~111.lpz %LOCALDIR%\br111.dat
copy /y levels\w~112.lpz %LOCALDIR%\br112.dat
copy /y levels\w~113.lpz %LOCALDIR%\br113.dat
copy /y levels\w~114.lpz %LOCALDIR%\br114.dat
copy /y levels\w~115.lpz %LOCALDIR%\br115.dat
copy /y levels\w~116.lpz %LOCALDIR%\br116.dat
copy /y levels\w~117end.lpz %LOCALDIR%\br117.dat
copy /y levels\w~201.lpz %LOCALDIR%\br201.dat
copy /y levels\w~202.lpz %LOCALDIR%\br202.dat
copy /y levels\w~203.lpz %LOCALDIR%\br203.dat
copy /y levels\w~204.lpz %LOCALDIR%\br204.dat
copy /y levels\w~205.lpz %LOCALDIR%\br205.dat
copy /y levels\w~206.lpz %LOCALDIR%\br206.dat
copy /y levels\w~207.lpz %LOCALDIR%\br207.dat
copy /y levels\w~208.lpz %LOCALDIR%\br208.dat
copy /y levels\w~209.lpz %LOCALDIR%\br209.dat
copy /y levels\w~210.lpz %LOCALDIR%\br210.dat
copy /y levels\w~211.lpz %LOCALDIR%\br211.dat
copy /y levels\w~212.lpz %LOCALDIR%\br212.dat
copy /y levels\w~213.lpz %LOCALDIR%\br213.dat
copy /y levels\w~214.lpz %LOCALDIR%\br214.dat
copy /y levels\w~215.lpz %LOCALDIR%\br215.dat
copy /y levels\w~216.lpz %LOCALDIR%\br216.dat
copy /y levels\w~217end.lpz %LOCALDIR%\br217.dat
