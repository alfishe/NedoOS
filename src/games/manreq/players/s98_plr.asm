...
;		call z,inc_d_paging
		...
		ld hl,(sync_cnt)
		ld bc,(timer1_nominator)
sync_FE_loop	and a
		adc hl,bc
		jp p,player_frame_complete_when_FE
...
timer1_nominator = $+1 :	ld bc,3277	;3277	;3276,8		;$8000		;
			and a
			adc hl,bc
			ld (sync_cnt),hl

			jp p,player_frame_complete
...
player_code
timer2_denominator = $+1 :	ld de,$0000
			ld hl,(sync_cnt)
			and a
			sbc hl,de
			ld (sync_cnt),hl
