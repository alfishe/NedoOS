;--------------------------------
;Super Mario Bros (JU)
;в версии для Европы отличается таблица частот (сама музыка, вроде бы та же, но смещена в памяти на 1 байт)
;смещения в коде есть и в других местах
;ПЗУ тайлов совпадает
...
TimeRunningOutHdr:    .db $08, LOW TimeRunOutMusData, HIGH TimeRunOutMusData, $27, $18
Star_CloudHdr:        .db $20, LOW Star_CloudMData, HIGH Star_CloudMData, $2e, $1a, $40
EndOfLevelMusHdr:     .db $20, LOW WinLevelMusData, HIGH WinLevelMusData, $3d, $21
ResidualHeaderData:   .db $20, $c4, $fc, $3f, $1d
UndergroundMusHdr:    .db $18, LOW UndergroundMusData, HIGH UndergroundMusData, $00, $00
SilenceHdr:           .db $08, LOW SilenceData, HIGH SilenceData, $00
CastleMusHdr:         .db $00, LOW CastleMusData, HIGH CastleMusData, $93, $62
VictoryMusHdr:        .db $10, LOW VictoryMusData, HIGH VictoryMusData, $24, $14
GameOverMusHdr:       .db $18, LOW GameOverMusData, HIGH GameOverMusData, $1e, $14
WaterMusHdr:          .db $08, LOW WaterMusData, HIGH WaterMusData, $a0, $70, $68
WinCastleMusHdr:      .db $08, LOW EndOfCastleMusData, HIGH EndOfCastleMusData, $4c, $24
GroundLevelPart1Hdr:  .db $18, LOW GroundM_P1Data, HIGH GroundM_P1Data, $2d, $1c, $b8
GroundLevelPart2AHdr: .db $18, LOW GroundM_P2AData, HIGH GroundM_P2AData, $20, $12, $70
GroundLevelPart2BHdr: .db $18, LOW GroundM_P2BData, HIGH GroundM_P2BData, $1b, $10, $44
GroundLevelPart2CHdr: .db $18, LOW GroundM_P2CData, HIGH GroundM_P2CData, $11, $0a, $1c
GroundLevelPart3AHdr: .db $18, LOW GroundM_P3AData, HIGH GroundM_P3AData, $2d, $10, $58
GroundLevelPart3BHdr: .db $18, LOW GroundM_P3BData, HIGH GroundM_P3BData, $14, $0d, $3f
GroundLevelLeadInHdr: .db $18, LOW GroundMLdInData, HIGH GroundMLdInData, $15, $0d, $21
GroundLevelPart4AHdr: .db $18, LOW GroundM_P4AData, HIGH GroundM_P4AData, $18, $10, $7a
GroundLevelPart4BHdr: .db $18, LOW GroundM_P4BData, HIGH GroundM_P4BData, $19, $0f, $54
GroundLevelPart4CHdr: .db $18, LOW GroundM_P4CData, HIGH GroundM_P4CData, $1e, $12, $2b
DeathMusHdr:          .db $18, LOW DeathMusData, HIGH DeathMusData, $1e, $0f, $2d
...
;unused space (2 байта в европейской версии)
      .db $ff, $ff, $ff
