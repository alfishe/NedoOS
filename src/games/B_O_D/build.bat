...
rem sjasmplus --nologo --msg=war  players\s98_plr.asm
rem sjasmplus --nologo --msg=war  players\midi_plr.asm
rem sjasmplus --nologo --msg=war  players\rcp_plr.asm
rem sjasmplus --nologo --msg=war  players\vgm_plr.asm
