...
OPL4_VIBRATO_DEPTH_MASK_INV     =   0xF8
;OPL4_VIBRATO_DEPTH_MASK         =   00111000b   ;0x07
;OPL4_VIBRATO_DEPTH_MASK_INV     =   11000111b   ;0xF8
