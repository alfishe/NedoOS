...
;	ifndef TFM	;для TurboSound!!! выключено для TFM
       ;OUT (C),B ;AY 0x1(0)      ;т.к.может вырубиться при HY=0xFF ;РАСКОММЕНТИРОВАТЬ для TurboSound!!!
...
;        LD B,0xBF
;	endif
       LD D,(IX+5) ;младший байт тона может быть 0xfe!!!
        OUT (C),D
        LD B,0xFF
