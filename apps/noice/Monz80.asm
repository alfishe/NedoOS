...
;  This file may be assembled with the Zilog ASM800 assembler
;
...
SERIAL_STATUS   EQU     0xfdef
SERIAL_DATA     EQU     0xf8ef
RXRDY           EQU     0       ; BIT NUMBER (NOT MASK) FOR RX BUFFER FULL
TXRDY           EQU     5       ; BIT NUMBER (NOT MASK) FOR TX BUFFER EMPTY
...
B0:     RST     30H                     ;10+ BREAKPOINT INSTRUCTION
B1:
  if Z80
...
; [16:28:39] <savelij13> по чтению регистра R там проверять битик
; [16:29:51] <savelij13> LD A,I
; [16:29:52] <savelij13> JP PE,RST08_WORK1
; [16:29:52] <savelij13> LD A,I
; [16:29:52] <savelij13> RST08_WORK1 DI
; [16:30:07] <savelij13> это проверка с учетом глюка в анрыле )
; [16:30:25] <savelij13> 	JP PO,EXIT_RST084
; [16:30:26] <savelij13> EI
; [16:30:26] <savelij13> EXIT_RST084
; [16:30:29] <savelij13> это на выхоед
; [16:32:48] <DMlog_> странная конструкцыя
BRK_POINT:
        PUSH    AF
        LD      A,1                     ;STATE = 1 (BREAKPOINT)
        ;JP      INT_ENTRY
...
;  Switch to user stack
        ...
        LD      A,(REG_STATE)
        CP      1
        JR      NZ,RUN_NOTBP        	;JIF NOT A BREAKPOINT
;
