...
GIF_SPEC;—пециальный фрейм.
        ...
        RET C
;       CP #FF
;       JR NZ,GIF_QT;Ќеопознаное приложение
        ;HELP
GIF_HELP CALL GETBYTE
        ...
        JP Z,GIF_LP0
        LD B,A
GIF_HP0 CALL GETBYTE    ;ѕропустить HELP...
        RET C
        DJNZ GIF_HP0
        JR GIF_HELP
...
MULWORD ;”множение слова на слово.
        ;¬ход: DE=ћножимое,BC=множитель.
        ;¬ыход:HLBC=DE*BC
        LD HL,0
        LD A,17
MULWOR0 RR B
...
GIFSEARCH;ѕоиск GIF-a в потоке данных.
        LD HL,GIF_HEAD0
        LD DE,GIF_HEAD1
        LD B,6-1
GIFSEARCH0
...
;out: a, z=(a==0)
        ;jr $
        PUSH HL
GETBYT1 LD HL,-1;0 ;јдрес в буфере.
        ;BIT 6,H
        ;JR NZ,GETBYT2
         ld a,h
