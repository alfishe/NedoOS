...
/* ==================================== */
/* 					*/
/*	PIA Control Registes 		*/
/* 					*/
/* ==================================== */

sfr P1DDR	= 0x0E0;		/* PIA1 Data Direction Reg */
sfr P1DP	= 0x0E1;		/* PIA1 Data Port */
sfr P2DDR	= 0x0E2;		/* PIA2 Data Direction Reg */
sfr P2DP	= 0x0E3;		/* PIA1 Data Port */

/* ==================================== */
/* 					*/
/*	CTC Control Registes 		*/
/* 					*/
/* ==================================== */

sfr CTC0	= 0x0E4;		/* CTC Channel 0 Ctrl Reg */
sfr CTC1	= 0x0E5;		/* CTC Channel 1 Ctrl Reg */
sfr CTC2	= 0x0E6;		/* CTC Channel 2 Ctrl Reg */
sfr CTC3	= 0x0E7;		/* CTC Channel 3 Ctrl Reg */
...
sfr SCCCR	= 0x0E8;		/* SCC Ctrl Reg */
sfr SCCDR	= 0x0E9;		/* SCC Data Reg */

/* ==================================== */
/* 					*/
/*   Registes for System Configuration	*/
/* 					*/
/* ==================================== */

sfr RAMUBR	= 0x0EA;		/* RAM Upper Boundary Addr Reg */
sfr RAMLBR	= 0x0EB;		/* RAM Lower Boundary Addr Reg */
sfr ROMBR	= 0x0EC;		/* ROM Addr Boundary Reg */
sfr SCR		= 0x0ED;		/* System Configuration Reg */
